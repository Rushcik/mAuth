package dev.rushcik.mauth.handler;
...
import dev.rushcik.mauth.event.PostAuthorizationEvent;
import dev.rushcik.mauth.event.PostRegisterEvent;
...
public class AuthSessionHandler implements LimboSessionHandler {
  ...
  public AuthSessionHandler(Dao<RegisteredPlayer, String> playerDao, Player proxyPlayer, mAuth plugin, @Nullable RegisteredPlayer playerInfo) {
  ...
  public void onChat(String message) {
    ...
    if (!mAuth.RATELIMITER.attempt(this.proxyPlayer.getRemoteAddress().getAddress())) {
